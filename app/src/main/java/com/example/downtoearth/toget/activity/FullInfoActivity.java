...
public class FullInfoActivity extends BaseActivity implements View.OnClickListener {
...
//                .scaleEnabled(true)//是否可缩放
            ...
            case R.id.layout_birthday:
                ...
                picker1.setSelectedItem(1997, 11, 20);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case MadeItemActivity.REQUEST_CODE:
                if (resultCode == MadeItemActivity.REQUEST_SUCCESS) {
