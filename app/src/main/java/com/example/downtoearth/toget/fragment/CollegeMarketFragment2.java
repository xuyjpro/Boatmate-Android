...
public class CollegeMarketFragment2 extends BaseFragment {
    ...
    public static CollegeMarketFragment2 newInstance(int category, boolean isMy) {
        CollegeMarketFragment2 fragment = new CollegeMarketFragment2();
